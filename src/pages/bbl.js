        ...
        <div className="mt-12 md:mt-20 px-4 md:px-20 font-Jost">
            ...
            <div className=" w-full flex items-center justify-center">
                <button className=" py-2 px-4 rounded-[50px] text-center mt-3 bg-[#a183305b]">
                    <p className=" gradient-text">Butt Aesthetics</p>
                </button>
            </div>
            ...
            <div className=" md:px-[15%] mt-8 mb-[64px] ">
                <div className="  text-justify border-y py-6">
                    <p className=" text-base font-semibold text-[#121212]">How Brazillian But Lift is performed?</p>
                    <div className=" mt-3 text-[#676767] text-sm">
                        In butt aesthetic, patient’s own fat is used to shape the hips As the fat is from the patient, results are completely natural and it won’t be understood that those flawless hips are operation results. If the patient lack sufficient fat to be transferred, filling materials can be used as well.<br/><br/>
                    ...
                    <p className=" text-base font-semibold text-[#121212] mt-6">Preparation</p>
                    <div className=" mt-3 text-[#676767] text-sm">
                    ...
                    <p className=" text-base font-semibold text-[#121212] mt-6">Variety</p>
                    <div className=" mt-3 text-[#676767] text-sm">
