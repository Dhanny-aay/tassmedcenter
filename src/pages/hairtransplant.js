        ...
        <div className="mt-12 md:mt-16 px-4 md:px-20 font-Jost">
            ...
            <div className=" w-full flex items-center justify-center">
                <button className=" py-2 px-4 rounded-[50px] text-center mt-3 bg-[#a183305b]">
                    <p className=" gradient-text">Hair Transplant</p>
                </button>
            </div>
            ...
            <div className=" md:px-[15%] mt-8 mb-[64px] ">
                <div className="  text-justify border-y py-6">
                    ...
                    <p className=" text-base font-semibold text-[#121212] mt-6">How is hair transplantation examination performed?</p>
                    <div className=" mt-3 text-[#676767] text-sm">
                    ...
                    <p className=" text-base font-semibold text-[#121212] mt-6">Hair Transplant  Methods</p>
                    <div className=" mt-3 text-[#676767] text-sm">
                        he method to be used is decided during the examination after the donor site is determined. Today, there are two methods for hair transplantation: FUT and FUE.<br/>
                        Both methods enable transfer of living hair follicles and do not require general anesthesia. Their difference is in the collection method of hair follicles.<br/>
                        1-FUE : This is the one-by-one hair follicle collection method from the hair area between the two ears or from abovementioned alternate regions by using special device heads that have 0.70-0.80 and 0.90 mm diameter with the use of a micromotor. No use of scalpel in the donor site, no suture and no visible scars in the donor site are among the greatest advantages. More follicles (grafts) can be collected by FUE method and it enables more natural and thick hair growth. This method provides 3000-4000 follicles (grafts) from patients with average hair density.<br/><br/>


                        2-FUT (Follicular Unit Transplantation): This is the separation of follicles (graft), collected by dissecting the scalp between the two ears as a strip, under the microscope. This method is rarely or not preferred at all with the development of FUE method. The reason is in FUT method, scars are left in the donor site and desired number of follicles cannot be collected. Scalpel is used for this method and donor site is sutured; scar is apparent after shaving. Transplanted hair will never be lost again. The most important thing to remember before and after hair transplantation is that each patient is unique and all assessments must be performed exclusively. You can easily get back to your normal life within a few days as the procedure is performed under local anesthesia in hospital conditions. In our Tass Medical center we don’t use FUT method as we prefer innovative hair transplantation techniques and place utmost importance to patient comfort.
                    </div>

                    <p className=" text-base font-semibold text-[#121212] mt-6">Hair Transplant Stages</p>
                    <div className=" mt-3 text-[#676767] text-sm">
                    ...
                    <p className=" text-base font-semibold text-[#121212] mt-6">Before the Hair Transplant  Operation</p>
                    <div className=" mt-3 text-[#676767] text-sm">
                        You have to make some preparation at home before you come for Hair Transplant . In the morning of the Hair Transplant  operation, there will be some preparation for you at the clinic before the procedure.<br/>
                        Preparations before coming to the clinic<br/>
                        •    Do the preparations instructed by your doctor for home and stop the drugs specified by your doctor that may cause side effects 1 week before the Hair Transplant procedure.<br/>
                        •    Start using B and E vitamins recommended by your doctor.<br/>
                        •    You can accelerate the blood circulation of the areas with donor and receiver site massage 2 days prior to the operation.<br/>
                        •    If your are going to have your hair cut before Hair Transplant, contact your doctor first.<br/>
                        •    Take a shower the night before the operation, clean and rinse your hair.<br/>
                        •    Start the operation day with a nice breakfast and come for the operation with a full stomach.<br/>
                        •    Avoid active, tiresome and stressful activities and sports before the procedure and come to the clinic as well-rested.<br/>
                        •    Come with a comfortable cotton hat that is not tight to use after the procedure.
                    </div>

                    <p className=" text-base font-semibold text-[#121212] mt-6">Before Hair Transplant </p>
                    <div className=" mt-3 text-[#676767] text-sm">
                        Your doctor will review the planning decided during your examination and will invite you to the clinic room for transplantation. You can ask all questions you may have at this stage. Your picture will be taken by a medical photographer before the operation and then the procedure will start.
                    </div>

                    <p className=" text-base font-semibold text-[#121212] mt-6">Hair Transplant Operation</p>
                    <div className=" mt-3 text-[#676767] text-sm">
                        In general, hair transplantation follows below steps:<br/>
                        •    Determined donor site is prepared<br/>
                        •    Then, transplantation site where collected follicles will be transferred to is prepared.<br/>
                        •    Follicles to be transplanted are prepared for the procedure.<br/>
                        •    Finally, Hair Transplant  is performed and hair follicles are placed to their new locations<br/><br/>

                        .
                        After taking your pictures, lines will be drawn to your head to restrict the area. Local anesthesia is performed so that you don't feel pain. You can read a book, watch television or even sleep during this time.<br/>
                        As the donor site is one of the most precious treasure of the patients with baldness, your doctor will collect the hair follicle with utmost care without damaging. There will be a break after a certain amount of time depending on the baldness degree and number of collected hair follicles.<br/><br/>
                    ...
                    <p className=" text-base font-semibold text-[#121212] mt-6">Hair growth after Hair Transplant</p>
                    <div className=" mt-3 text-[#676767] text-sm">
                        ...
                        The most important thing to know is whether hair will be fed or not after transplantation. If your hair is not fed properly and in healthy way, hair loss will be inevitable again. We suggest you to refer our doctors for detailed information. Contact us now and ask your questions to our doctors.
                    </div>
                </div>
            </div>
        </div>
